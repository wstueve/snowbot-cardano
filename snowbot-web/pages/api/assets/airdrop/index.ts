...
import { CreateAirdropCommand } from "../../../../components/type/airdrop";
import { createAirdrop, getAirdrops } from "../../../../components/logic/airdrop";
...
export default async function handler(
  ...
  if (req.method === 'POST') {
    const command = {
      ...req.body as CreateAirdropCommand
    };
    ...
    const airdrop = await createAirdrop(userId, command);
